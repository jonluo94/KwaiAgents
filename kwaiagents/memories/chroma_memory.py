...
class ChromaCollectionMemory(CollectionMemory):
    ...
    def query(
        ...
        return self.collection.query(query_embeddings=query_embeddings, query_texts=query_texts, n_results=n_results,
...
def create_client():
    return ChromaMemory(path=CHROMADB_STORAGE_PATH)
